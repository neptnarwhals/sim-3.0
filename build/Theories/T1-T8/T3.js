...
class t3Sim extends theoryClass {
    ...
    constructor(data) {
        ...
        this.variables = [
            ...
            new Variable({ cost: new ExponentialCost(20, 6.3496), valueScaling: new LinearValue(2) }),
            new Variable({ cost: new ExponentialCost(10, 2.74), valueScaling: new LinearValue(2) }),
            new Variable({ cost: new ExponentialCost(1000, 1.965), valueScaling: new LinearValue(2) }),
            new Variable({ cost: new ExponentialCost(500, 18.8343), valueScaling: new LinearValue(2) }),
            new Variable({ cost: new ExponentialCost(1e5, 3.65), valueScaling: new LinearValue(2) }),
            new Variable({ cost: new ExponentialCost(1e5, 2.27), valueScaling: new LinearValue(2) }),
            new Variable({ cost: new ExponentialCost(1e4, 1248.27), valueScaling: new LinearValue(2) }),
            new Variable({ cost: new ExponentialCost(1e3, 6.81744), valueScaling: new LinearValue(2) }),
